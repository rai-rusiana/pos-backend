...
export const getCategoryById = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json(category); // No need to wrap in an object
  } catch (error) {
...
export const updateCategory = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json(updatedCategory); // No need to wrap in an object
  } catch (error) {
...
export const getItemsByCategory = async (req, res) => {
  ...
  try {
    ...
    const categoryItems = await categoryService.getItemsByCategoryId(parseInt(id, 10));
