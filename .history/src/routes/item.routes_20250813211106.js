...
router.post('/items/bulk', authenticateToken, authorizeRole(['ADMIN', 'MANAGER']), itemController.bulkCreateInventoryItems);

// Route to get all inventory items for a given rack.
// Accessible to all authenticated users.
// Example: GET /api/inventories/1/items/by-rack
router.get('/:id/items/by-rack', authenticateToken, itemController.getInventoryItemsByRack);
